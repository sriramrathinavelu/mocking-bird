...
(function ($, undefined) {
    $.widget("daredevel.tree", {
        ...
        _markAsCollapsed: function (li) {
            ...
            anchor.removeClass('icon ' + this.options.expandUiIcon + ' ' + this.options.leafUiIcon);

            if (this.options.collapseUiIcon.length > 0) {
                anchor.addClass('icon ' + this.options.collapseUiIcon)
            }
        ...
        _markAsExpanded: function (li) {
            ...
            anchor.removeClass('icon ' + this.options.collapseUiIcon + ' ' + this.options.leafUiIcon);

            if (this.options.expandUiIcon.length > 0) {
                anchor.addClass('icon ' + this.options.expandUiIcon)
            }
        ...
        _markAsLeaf: function (li) {
            ...
            anchor.removeClass('icon ' + this.options.collapseUiIcon + ' ' + this.options.expandUiIcon);

            if (this.options.leafUiIcon.length > 0) {
                anchor.addClass('icon ' + this.options.leafUiIcon)
            }
